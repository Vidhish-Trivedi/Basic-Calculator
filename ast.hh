...
namespace ast
{
    ...
    */
    ...
    public:
        ...
        virtual ~BoolExpression() = 0;
    };

    // ADDED
    class Bool : public BoolExpression
    {
    public:
        const bool value;
        Bool(bool v);
    ...
    // For now, we will have only int variables, not boolean variables.

    // ADDED
    class BinaryBoolExpression : public BoolExpression
    {
    protected:
        Expression *left;
        Expression *right;
    ...
    public:
        BinaryBoolExpression(Expression *l, Expression *r);
        virtual ~BinaryBoolExpression();
    };

    // ADDED
    class GreaterExpression : public BinaryBoolExpression
    {
        // l > r
    public:
        GreaterExpression(Expression *l, Expression *r);
        virtual bool evaluate();
    };
    class LesserExpression : public BinaryBoolExpression
    {
        // l < r
    public:
        LesserExpression(Expression *l, Expression *r);
        virtual bool evaluate();
    };

    // ADDED
    class EqualsExpression : public BinaryBoolExpression
    {
        // l == r
    public:
        EqualsExpression(Expression *l, Expression *r);
        virtual bool evaluate();
    };
    ...
    public:
        IfStatement(BoolExpression *cond, SequenceStatement *seq);
        virtual void run();
        virtual ~IfStatement();
    };
    ...
    public:
        WhileStatement(BoolExpression *cond, SequenceStatement *seq);
        virtual void run();
